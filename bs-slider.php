    ...
    <div class="row">
      ...
      <div class="col-md-9">
          ...
          <div class="carousel-inner">
            ...
            <?php if ( have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
              ...
              <div class="item <?php if( $the_query->current_post == 0 ):?>active<?php endif; ?>">
                ...
                <a href="<?php the_permalink(); ?>"><img src="<?php echo $thumbnail_url[0]; ?>" alt="<?php echo $thumbnail_meta;?>">
                <div class="carousel-caption"><?php the_title(); ?></div></a>
              </div>
        ...
        <?php endwhile; else: ?>
          ...
          <p>There appears to be no content on this page.</p>
